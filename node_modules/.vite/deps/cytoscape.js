...
styfn$8.checkBoundsTrigger = function(ele, name, fromValue, toValue) {
  this.checkTrigger(ele, name, fromValue, toValue, function(prop) {
    ...
    ele.dirtyCompoundBoundsCache();
    ele.dirtyBoundingBoxCache();
    if (prop.triggersBoundsOfParallelBeziers && name === "curve-style" && (fromValue === "bezier" || toValue === "bezier")) {
...
styfn$1.parseImpl = function(name, value, propIsBypass, propIsFlat) {
  ...
  if (!valueIsString || propIsFlat || value.length < 7 || value[1] !== "a")
    ...
    if (valueMin.pfValue === valueMax.pfValue || valueMin.strValue === valueMax.strValue) {
      ...
      var same2 = c1[0] === c2[0] && c1[1] === c2[1] && c1[2] === c2[2] && (c1[3] === c2[3] || (c1[3] == null || c1[3] === 1) && (c2[3] == null || c2[3] === 1));
      if (same2) {
        return false;
      }
    }
...
BreadthFirstLayout.prototype.run = function() {
  ...
  var distanceY = Math.max(
    depthsLen === 1 ? 0 : hasBoundingBox ? (bb.h - options2.padding * 2 - aveNodeSize.h) / (depthsLen - 1) : (bb.h - options2.padding * 2 - aveNodeSize.h) / (depthsLen + 1),
    minDistance
  );
  ...
  var getPosition = function getPosition2(ele2) {
    ...
    if (options2.circle) {
      ...
      var distanceX = Math.max(
        depthSize === 1 ? 0 : hasBoundingBox ? (bb.w - options2.padding * 2 - aveNodeSize.w) / ((options2.grid ? maxDepthSize : depthSize) - 1) : (bb.w - options2.padding * 2 - aveNodeSize.w) / ((options2.grid ? maxDepthSize : depthSize) + 1),
        minDistance
      );
      var epos = {
